 ...
 *   include/global_form.php for more details)
 *
 * @return - $form_array with all available variables substituted with their proper values
 */
 ...
 * @param $style_or_class - the style or class to apply to the table element
 * @param $title - optional title for the column
 */
 ...
 *
 * @return - true or false based on the value of the HTML checkbox
 */
 ...
 * @param $html_boolean - the value of the HTML checkbox
 *
 * @return - 'Selected' or 'Not Selected' based on the value of the HTML checkbox
 */
 ...
 *
 * @return - a CSS style string which should be used with an HTML checkbox control
 */
 ...
 *
 * @param $default - The default action is not set
 *
 * @return - null
 */
 ...
 *
 * @return - the number of seconds relative to now where the graph should begin
 */
 ...
 * the timespan selector
 *
 * @return - the number of seconds relative to now where the graph should end
 */
