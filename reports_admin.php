...
switch (get_request_var('action')) {
	...
	case 'send':
		...
		cacti_redirect('reports_admin.php?action=edit&tab=' . get_request_var('tab') . '&id=' . get_request_var('id'));
		break;
	case 'ajax_dnd':
		reports_item_dnd();

		cacti_redirect('reports_admin.php?action=edit&tab=items&id=' . get_request_var('id'));
		break;
	case 'setvar':
