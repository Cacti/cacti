...
function html_common_login_header($plugin_hook_name, $page_title, $form_title, $include_header) {
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<?php
	html_common_header(api_plugin_hook_function($plugin_hook_name, $page_title));
...
<body class='loginBody'>
	...
	<div class='loginCenter'>
		...
		<div class='loginArea'>
			<legend><?php print $form_title; ?></legend>
<?php
}

function html_common_login_footer($include_footer) {
?>
		</div>
		<div class='versionInfo'><?php print __('Version %1$s | %2$s', get_cacti_version(), COPYRIGHT_YEARS_SHORT);?></div>
	</div>
	<div class='loginRight'></div>
	<script type='text/javascript'>
	$(function() {
		$('body').css('height', $(window).height());
		$('.loginLeft').css('width',parseInt($(window).width()*0.40)+'px');
		$('.loginRight').css('width',parseInt($(window).width()*0.40)+'px');
