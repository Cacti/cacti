 ...
 */
function push_out_aggregates(int $aggregate_template_id, int $local_graph_id = 0) : bool {
	$attribs                     = [];
 ...
 * @param bool  $manage_transaction Start and finish the transaction in this function.
 *
