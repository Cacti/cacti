 ...
 * @param $delete_type - boolean to keep data source and graphs or remove
 */
 ...
 * @param $reindex_method - the reindex method to user when adding the data query
 */
 ...
 * @param $device_id - the id of the device which contains the mapping
 * @param $data_query_id - the id of the data query to remove the mapping for
 * @param $reindex_method - the reindex method to use when changing the data query
 */
 ...
 *
 * @param $save - the save structure for the device
 *
 * @return boolean
 */
 ...
 * @param $host_template_id - the id of the host template alter the device to
 */
 ...
 *
 * @param $device_template - the device template to syncronize
 * @param $host_ids - an array of host_ids or a string with a single host_id
 * @param $down_devices - also update mapping of down devices
 */
