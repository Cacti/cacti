				...
				<td class='center'>
					<table>
						<tr>
							...
							<?php if(!is_realm_allowed(2001)) { ?><td id='dd<?php print get_request_var('local_graph_id');?>' style='vertical-align:top;' class='graphDrillDown noprint'>
		...
		<td class='center'>
			<table>
				<tr>
					...
					<?php if(!is_realm_allowed(2001)) { ?><td id='dd<?php print $graph['local_graph_id'];?>' style='vertical-align:top;' class='graphDrillDown noprint'>
