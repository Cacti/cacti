					...
					<table width='1' cellpadding='0'>
						<tr>
							...
							<td valign='top' style='padding: 3px;' class='noprint'>
								...
								<?php if (read_config_option('realtime_enabled') == 'on') print "<a href='#' onclick=\"window.open('".$config['url_path']."graph_realtime.php?local_graph_id=" . $_GET['local_graph_id'] . "', 'popup_" . $_GET['local_graph_id'] . "', 'toolbar=no,menubar=no,resizable=yes,location=no,scrollbars=no,status=no,titlebar=no,width=650,height=300')\"><img src='".$config['url_path']."images/realtime.gif' border='0' alt='Realtime' title='Realtime' style='padding: 3px;'></a><br/>\n";?>
	...
	<tr>
		<td align='center'>
			<table width='1' cellpadding='0'>
				...
				<tr>
					<td colspan='2' align='center'>
						<strong><?php print htmlspecialchars(db_fetch_cell_prepared('SELECT name FROM rra WHERE id = ?', array($_GET['rra_id'])));?></strong>
					</td>
				</tr>
			</table>
		</td>
