...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td bgcolor="#454E53" colspan="<?php print $array_settings[column_number];?>" nowrap>
			<map name="tabs">
		...
		<td bgcolor="#454E53" align="right" nowrap>
			<a href="index.html"><img src="top_tabs_graph_preview<?php if ($action == "preview") { print "_down"; }?>.gif" border="0" alt="Preview View"></a><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td height="5" colspan="3" bgcolor="#<?php print $colors[panel];?>">
...
<table width="100%" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td bgcolor="#<?php print $colors[light];?>" width="1%"></td>
