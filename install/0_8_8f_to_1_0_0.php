...
function upgrade_to_1_0_0() {
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_auth_group` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_auth_group_perms` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_auth_group_realm` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_auth_group_members` (
		`group_id` int(10) unsigned NOT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `settings_graphs_group` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_daily` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_hourly` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
		`average` DOUBLE DEFAULT NULL,
		`peak` DOUBLE DEFAULT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_hourly_cache` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_hourly_last` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
		`value` DOUBLE DEFAULT NULL,
	...
	if (!sizeof(db_fetch_row("SHOW COLUMNS from data_source_stats_hourly_last where Field='calculated'"))) {
		db_install_execute('0.8.8f', "ALTER TABLE data_source_stats_hourly_last ADD calculated DOUBLE DEFAULT NULL AFTER `value`");
	};

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_monthly` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
		`average` DOUBLE DEFAULT NULL,
		`peak` DOUBLE DEFAULT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_weekly` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
		`average` DOUBLE DEFAULT NULL,
		`peak` DOUBLE DEFAULT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_stats_yearly` (
		`local_data_id` mediumint(8) unsigned NOT NULL,
		`rrd_name` varchar(19) NOT NULL,
		`average` DOUBLE DEFAULT NULL,
		`peak` DOUBLE DEFAULT NULL,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `poller_output_boost` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `poller_output_boost_processes` (
	...
	if (db_table_exists('plugin_domains')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_domains TO user_domains');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_domains` (
	...
	if (db_table_exists('plugin_domains_ldsp')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_domains_ldsp TO user_domains_ldap');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_domains_ldap` (
	...
	if (db_table_exists('plugin_snmpagent_cache')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_cache TO snmpagent_cache');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_cache` (
	...
	if (db_table_exists('plugin_snmpagent_mibs')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_mibs TO snmpagent_mibs');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_mibs` (
	...
	if (db_table_exists('plugin_snmpagent_cache_notifications')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_cache_notifications TO snmpagent_cache_notifications');
	}
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_cache_notifications` (
		`name` varchar(255) NOT NULL,
		`mib` varchar(255) NOT NULL,
	...
	if (db_table_exists('plugin_snmpagent_cache_textual_conventions')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_cache_textual_conventions TO snmpagent_cache_textual_conventions');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_cache_textual_conventions` (
		`name` varchar(255) NOT NULL,
		`mib` varchar(255) NOT NULL,
		`type` varchar(255) NOT NULL DEFAULT '',
		`description` varchar(5000) NOT NULL DEFAULT '',
	...
	if (db_table_exists('plugin_snmpagent_managers')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_managers TO snmpagent_managers');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_managers` (
		`id` int(8) NOT NULL AUTO_INCREMENT,
	...
	if (db_table_exists('plugin_snmpagent_managers_notifications')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_managers_notifications TO snmpagent_managers_notifications');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_managers_notifications` (
	...
	if (db_table_exists('plugin_snmpagent_notifications_log')) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_snmpagent_notifications_log TO snmpagent_notifications_log');
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `snmpagent_notifications_log` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_purge_temp` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `data_source_purge_action` (
		`id` integer UNSIGNED auto_increment,
		`name` varchar(128) NOT NULL default '',
		`local_data_id` mediumint(8) unsigned NOT NULL default '0',
	...
	db_install_execute('0.8.8f', "ALTER TABLE graph_tree 
	...
	db_install_execute('0.8.8f', "ALTER TABLE graph_tree_items 
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `user_auth_cache` (
		`user_id` int(10) unsigned NOT NULL DEFAULT '0',
	...
	if (isset($columns['order_key'])) {
		...
		db_install_execute('0.8.8f', "ALTER TABLE graph_tree_items DROP COLUMN order_key");
	}
	...
	db_install_execute('0.8.8f', "DELETE FROM plugin_realms WHERE file LIKE 'clog%'");
	db_install_execute('0.8.8f', "DELETE FROM plugin_config WHERE directory='clog'");
	db_install_execute('0.8.8f', "DELETE FROM plugin_hooks WHERE name='clog'");

	snmpagent_cache_install();

	// Adding email column for future user
	db_install_add_column ('0.8.8f', 'user_auth', array('name' => 'email_address', 'type' => 'varchar(128)', 'NULL' => true, 'after' => 'full_name'));

	db_install_execute('0.8.8f', 'DROP TABLE IF EXISTS poller_output_realtime');
	db_install_execute('0.8.8f', "CREATE TABLE poller_output_realtime (
		local_data_id mediumint(8) unsigned NOT NULL default '0',
		rrd_name varchar(19) NOT NULL default '',
		time timestamp NOT NULL default '0000-00-00 00:00:00',
	...
	db_install_execute('0.8.8f', 'DROP TABLE IF EXISTS poller_output_rt');

	db_install_execute('0.8.8f', "DELETE FROM plugin_realms WHERE file LIKE '%graph_image_rt%'");
	db_install_execute('0.8.8f', "DELETE FROM plugin_config WHERE directory='realtime'");
	db_install_execute('0.8.8f', "DELETE FROM plugin_hooks WHERE name='realtime'");

	// If we have never install Nectar before, we can simply install
	if (!sizeof(db_fetch_row("SHOW TABLES LIKE '%plugin_nectar%'"))) {
		db_install_execute('0.8.8f', "CREATE TABLE `reports` (
		...
		db_install_execute('0.8.8f', "CREATE TABLE `reports_items` (
			`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		...
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_nectar TO reports');
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_nectar_items TO reports_items');
		db_install_execute('0.8.8f', "UPDATE settings SET name=REPLACE(name, 'nectar','reports') WHERE name LIKE '%nectar%'");

		db_install_add_column ('0.8.8f', 'reports', array('name' => 'bcc',           'type' => 'TEXT', 'after' => 'email'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'from_name',     'type' => 'VARCHAR(40)',  'NULL' => false, 'default' => '', 'after' => 'mailtime'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'user_id',       'type' => 'mediumint(8)', 'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'id'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'graph_width',   'type' => 'smallint(2)',  'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'attachment_type'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'graph_height',  'type' => 'smallint(2)',  'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'graph_width'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'graph_columns', 'type' => 'smallint(2)',  'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'graph_height'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'thumbnails',    'type' => 'char(2)',      'NULL' => false, 'default' => '', 'after' => 'graph_columns'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'font_size',     'type' => 'smallint(2)',  'NULL' => false, 'default' => '16', 'after' => 'name'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'alignment',     'type' => 'smallint(2)',  'NULL' => false, 'default' => '0', 'after' => 'font_size'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'cformat',       'type' => 'char(2)',      'NULL' => false, 'default' => '', 'after' => 'name'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'format_file',   'type' => 'varchar(255)', 'NULL' => false, 'default' => '', 'after' => 'cformat'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'graph_linked',  'type' => 'char(2)',      'NULL' => false, 'default' => '', 'after' => 'alignment'));
		db_install_add_column ('0.8.8f', 'reports', array('name' => 'subject',       'type' => 'varchar(64)',  'NULL' => false, 'default' => '', 'after' => 'mailtime'));

		/* plugin_reports_items upgrade */
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'host_template_id',  'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'item_type'));
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'graph_template_id', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'host_id'));
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'tree_id',           'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'item_type'));
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'branch_id',         'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '0', 'after' => 'tree_id'));
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'tree_cascade',      'type' => 'char(2)', 'NULL' => false, 'default' => '', 'after' => 'branch_id'));
		db_install_add_column ('0.8.8f', 'reports_items', array('name' => 'graph_name_regexp', 'type' => 'varchar(128)', 'NULL' => false, 'default' => '', 'after' => 'tree_cascade'));
	...
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysDescr',          'type' => 'varchar(300)', 'NULL' => false, 'default' => '',  'after' => 'snmp_timeout'));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysObjectID',       'type' => 'varchar(64)',  'NULL' => false, 'default' => '',  'after' => 'snmp_sysDescr'));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysUpTimeInstance', 'type' => 'int',          'NULL' => false, 'default' => '0', 'after' => 'snmp_sysObjectID', 'unsigned' => true));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysContact',        'type' => 'varchar(300)', 'NULL' => false, 'default' => '',  'after' => 'snmp_sysUpTimeInstance'));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysName',           'type' => 'varchar(300)', 'NULL' => false, 'default' => '',  'after' => 'snmp_sysContact'));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'snmp_sysLocation',       'type' => 'varchar(300)', 'NULL' => false, 'default' => '',  'after' => 'snmp_sysName'));
	db_install_add_column ('0.8.8f', 'host', array('name' => 'polling_time',           'type' => 'DOUBLE',                        'default' => '0', 'after' => 'avg_time'));

	// Add realms to the admin user if it exists
	if (sizeof(db_fetch_row('SELECT * FROM user_auth WHERE id=1'))) {
		db_install_execute('0.8.8f', 'INSERT IGNORE INTO user_auth_realm VALUES (18,1)');
        db_install_execute('0.8.8f', 'INSERT IGNORE INTO user_auth_realm VALUES (20,1)');
        db_install_execute('0.8.8f', 'INSERT IGNORE INTO user_auth_realm VALUES (21,1)');
	}
	...
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_color_template_items TO color_template_items');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_color_templates TO color_templates');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graph_templates TO aggregate_graph_templates');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graph_templates_graph TO aggregate_graph_templates_graph');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graph_templates_item TO aggregate_graph_templates_item');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graphs TO aggregate_graphs');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graphs_graph_item TO aggregate_graphs_graph_item');
	db_install_execute('0.8.8f', 'RENAME TABLE plugin_aggregate_graphs_items TO aggregate_graphs_items');
	...
	foreach($autom8_tables as $table) {
		if (in_array($table, $tables)) {
			db_install_execute('0.8.8f', "RENAME TABLE $table TO " . str_replace('plugin_autom8', 'automation', $table));
		}
	}
	...
	if (in_array('plugin_discover_hosts', $tables)) {
		db_install_execute('0.8.8f', 'RENAME TABLE plugin_discover_hosts TO automation_devices');
		db_install_execute('0.8.8f', "ALTER TABLE automation_devices 
		...
		if (in_array('plugin_discover_processes', $tables)) {
			db_install_execute('0.8.8f', 'DROP TABLE IF EXISTS plugin_discover_processes');
		}

		if (in_array('plugin_discover_template', $tables)) {
			db_install_execute('0.8.8f', 'RENAME TABLE plugin_discover_template TO automation_templates');
			db_install_execute('0.8.8f', "ALTER TABLE automation_templates 
			...
			db_install_execute('0.8.8f', "UPDATE automation_templates SET sequence=id");
		}
	}

	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_devices` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_ips` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_networks` (
		`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_processes` (
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_snmp` (
		`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		`name` varchar(100) NOT NULL DEFAULT '',
		PRIMARY KEY (`id`)) 
		ENGINE=MyISAM 
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_snmp_items` (
		`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	...
	db_install_execute('0.8.8f', "CREATE TABLE IF NOT EXISTS `automation_templates` (
		`id` int(8) NOT NULL AUTO_INCREMENT,
