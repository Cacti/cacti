...
function upgrade_to_0_8_6e() {
	...
	db_install_execute("0.8.6e", "ALTER TABLE `graph_template_graph` CHANGE `upper_limit` `upper_limit` VARCHAR( 20 ) NOT NULL;");
	db_install_execute("0.8.6e", "ALTER TABLE `graph_template_graph` CHANGE `lower_limit` `lower_limit` VARCHAR( 20 ) NOT NULL;");}
?>