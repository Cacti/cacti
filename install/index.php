...
$cacti_versions = array("0.8", "0.8.1", "0.8.2", "0.8.2a", "0.8.3", "0.8.3a", "0.8.4", "0.8.5", "0.8.5a", "0.8.6", "0.8.6a", "0.8.6b", "0.8.6c", "0.8.6d", "0.8.6e", "0.8.6f", "0.8.6g", "0.8.6h", "0.8.6i", "0.8.6j", "0.8.6k");
...
if ($_REQUEST["step"] == "4") {
	...
	for ($i=($old_version_index+1); $i<count($cacti_versions); $i++) {
		if ($cacti_versions[$i] == "0.8.1") {
			...
			upgrade_to_0_8_6i();
		}elseif ($cacti_versions[$i] == "0.8.6j") {
			include ("0_8_6j_to_0_8_6k.php");
			upgrade_to_0_8_6k();
		}
	}
}
