...
/* Set datetime format before any of the following includes *
 * to ensure that the datetime format used is consistent    */
include_once($config['include_path'] . '/global_datetime.php');
