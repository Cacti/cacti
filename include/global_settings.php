...
$settings = array(
	...
	'general' => array(
		...
		'content_security_policy_script' => array(
			...
			'description' => __('Controls the script-src CSP policy.  Nonce Modes require every Cacti Plugin using inline script and style to call CactiSecureHeaders::getNonceAttribute(); function.  Without it, those scripts will be blocked by the browser.'),
			'default' => '',
			'array' => array(
