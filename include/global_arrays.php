...
$automation_op_array = array(
	...
	'op' => array(
		AUTOMATION_OP_NONE          => '',
		AUTOMATION_OP_CONTAINS      => __('LIKE'),
		AUTOMATION_OP_CONTAINS_NOT  => __('NOT LIKE'),
		AUTOMATION_OP_BEGINS        => __('LIKE'),
		AUTOMATION_OP_BEGINS_NOT    => __('NOT LIKE'),
		AUTOMATION_OP_ENDS          => __('LIKE'),
		AUTOMATION_OP_ENDS_NOT      => __('NOT LIKE'),
		AUTOMATION_OP_MATCHES       => __('<=>'),
		AUTOMATION_OP_MATCHES_NOT   => __('<>'),
		AUTOMATION_OP_LT            => __('<'),
		AUTOMATION_OP_LE            => __('<='),
		AUTOMATION_OP_GT            => __('>'),
		AUTOMATION_OP_GE            => __('>='),
		...
		AUTOMATION_OP_EMPTY         => __("LIKE ''"),
		AUTOMATION_OP_NOT_EMPTY     => __("NOT LIKE ''"),
		AUTOMATION_OP_REGEXP        => __('REGEXP'),
		AUTOMATION_OP_NOT_REGEXP    => __('NOT REGEXP'),
	),
	'binary' => array(
