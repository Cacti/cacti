...
$messages = array(
	...
	'poller_nosync' => array(
		...
		'level' => MESSAGE_LEVEL_ERROR),
	'poller_nodupe' => array(
		'message' => __('When saving a Remote Data Collector, the DB Hostname must be unique from all others.'),
		'level' => MESSAGE_LEVEL_ERROR),
	'poller_dbhost' => array(
		'message' => __('Your DB Hostname must be something other than localhost for each Remote Data Collector..'),
		'level' => MESSAGE_LEVEL_ERROR),
	'reports_save' => array(
