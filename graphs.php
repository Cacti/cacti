...
function item() {
	...
	foreach ($template_item_list as $item) {
		...
		print "<td>";
		if (empty($graph_template_id)) { print "<a href='graphs_items.php?action=item_edit&id=" . $item["id"] . "&local_graph_id=" . $_GET["id"] . "'>"; }
		...
		if (empty($graph_template_id)) {
			print "<td><a href='graphs_items.php?action=item_movedown&id=" . $item["id"] . "&local_graph_id=" . $_GET["id"] . "'><img src='images/move_down.gif' border='0' alt='Move Down'></a>
					<a href='graphs_items.php?action=item_moveup&id=" . $item["id"] . "&local_graph_id=" . $_GET["id"] . "'><img src='images/move_up.gif' border='0' alt='Move Up'></a></td>\n";
			print "<td width='1%' align='right'><a href='graphs_items.php?action=item_remove&id=" . $item["id"] . "&local_graph_id=" . $_GET["id"] . "'><img src='images/delete_icon.gif' width='10' height='10' border='0' alt='Delete'></a>&nbsp;</td>\n";
		}
